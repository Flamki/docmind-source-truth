...
export const Route = createFileRoute("/sign-up")({
  head: () => ({ meta: [{ title: "Create account — DocMind" }] }),
  component: SignUp,
});
...
function SignUp() {
  ...
  return (
    <AuthLayout>
      ...
      <p className="mt-1.5 text-sm text-text-secondary">Start with 3 sample documents.</p>
      <form
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        <div className="space-y-1.5">
          ...
          <Input id="name" placeholder="Ayush Singh" />
        </div>
        <div className="space-y-1.5">
