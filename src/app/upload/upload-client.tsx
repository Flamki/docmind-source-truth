        ...
        <div className="mt-8 rounded-xl border border-border bg-surface p-6">
            ...
            <div
              ...
              className={`flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed p-12 text-center transition ${
                dragOver
                  ...
                  : "border-border hover:border-text-muted hover:bg-surface-soft"
              }`}
            >
              ...
              <div className="flex items-center gap-3 rounded-lg border border-border bg-background p-3">
                ...
                {stage === "selected" && (
                  <button
                    ...
                    className="rounded p-1.5 text-text-muted hover:bg-surface-soft hover:text-foreground"
                  >
                    <X className="h-4 w-4" />
                  </button>
                )}
                  ...
                  {steps.map((s, i) => {
                    ...
                    return (
                      <div key={s} className="flex items-center gap-3 text-sm">
                        ...
                        {active && (
                          <div className="ml-auto h-1 w-16 overflow-hidden rounded-full bg-surface-soft">
              ...
              {stage === "done" && (
                <div className="rounded-lg border border-[color:var(--color-success)]/20 bg-[color:var(--color-success)]/5 p-5 text-center">
                  ...
                  <p className="mt-1 text-sm text-text-secondary">
                    You can now ask questions and view citations.
                  </p>
                  <div className="mt-4 flex justify-center gap-2">
                    <Button onClick={() => router.push("/documents")} className="gap-1.5">
          ...
          {stage === "error" && (
            <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-6 text-center">
              ...
              <Button className="mt-4" variant="outline" onClick={() => setStage("idle")}>
                Try again
              </Button>
            </div>
          )}
