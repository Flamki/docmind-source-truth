              ...
              {["Light", "Dark", "System"].map((t) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    if (t === "System") document.documentElement.classList.remove("dark");
                  }}
            ...
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <div className="mt-0.5 text-xs text-text-secondary">
                  Removes all documents, chats, and citations.
                </div>
              </div>
...
function Section({
  ...
  return (
    <section
      className={`rounded-xl border ${destructive ? "border-destructive/30" : "border-border"} bg-surface p-6`}
    >
      <div className="mb-4">
        <h2 className={`text-base font-semibold ${destructive ? "text-destructive" : ""}`}>
          {title}
        </h2>
